...
struct Item: Hashable {
  ...
  // implement tge hashable property for Item
  ...
  static func testData() -> [Item] {
    return [
      Item(name: "Airpods", price: 129.99, category: .workout),
      ...
      Item(name: "Tri shoes", price: 120.00, category: .gaming),
      Item(name: "Tri suit", price: 240.00, category: .workout),
      Item(name: "Turtle Beach A50", price: 150.00, category: .gaming),
      ...
      Item(name: "BISSELL Cleanview Swivel Pet", price: 99.99, category: .health),
      Item(name: "Ninja Professional", price: 89.99, category: .health),
      Item(name: "Debrox Swimmer's Ear", price: 7.99, category: .technology),
      Item(name: "Tylenol Extra Strength", price: 9.47, category: .gaming)
    ]
  }
